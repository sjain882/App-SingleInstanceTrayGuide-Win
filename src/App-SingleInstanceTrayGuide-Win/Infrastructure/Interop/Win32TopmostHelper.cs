...
namespace App_SingleInstanceTrayGuide_Win.Infrastructure.Interop;

public static class Win32TopmostHelper
{
    ...
    public static void EnsureTopmost(Window window)
    {
        ...
        // Intentionally fire-and-forget: dispatcher owns lifetime
